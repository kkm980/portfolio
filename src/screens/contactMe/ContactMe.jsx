  ...
  return (
    ...
    textJustify: "inter-word",  textWrap:"wrap"}}>Hey, I love collaborating with new people, adapting with emerging technologies and exploring places. What about a cup of coffee with me?</h4>
      ...
      <div data-aos="slide-up" className="contactMe__data__links" style={{display:"flex", flexWrap:"wrap"}}>
        ...
        <p   > <a  style={{textDecoration:"none", textTransform:"none"}} rel="noreferrer" href="mailto:kantkrishna751@gmail.com?subject=Let us connect for future projects" target="_blank">Send me a <img src={mail} height="25px" alt="medium"/></a></p>

        <p  ><a  style={{textDecoration:"none", textTransform:"none"}} href="tel:+919801184456">Click to <img src={call} height="25px" alt="medium"/> 8921277536</a></p>
        ...
        <p  ><a rel="noreferrer" style={{textDecoration:"none", textTransform:"none"}} href="https://github.com/kkm980" target="_blank">Catch me here <img src={github} height="30px" alt="github"/></a></p>
