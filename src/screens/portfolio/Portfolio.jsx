  ...
  return (
    <div className="portfolio__main__container" id="projects">
      ...
      <p data-aos="fade-down" >Pay a visit 
        <a className="nextLink" style={{color:"black" , marginLeft:"10px", textDecoration:"none"}} href="https://drive.google.com/file/d/1yFIjMJK154fGBsplAxlbg0q9fOybc7bL/view?usp=sharing" target="_blank" rel="noreferrer">Resume</a>
      </p>
